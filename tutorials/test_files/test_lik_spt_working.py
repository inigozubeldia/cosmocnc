...
for i in range(0,len(data_lik_from_abundances)):
    ...
    # number_counts.cnc_params["observables"] = [["xi","Yx"]]
    ...
    number_counts.cnc_params["n_points_data_lik"] = 128 #64*4#2**13, ##number of points in which the mass function at each redshift (and all the convolutions) is evaluated
    ...
    number_counts.scal_rel_params["dof"] = 3.
    number_counts.scal_rel_params["q_cutoff"] = 2
