...
scaling_relations = {"q_mmf3_mean":sr.scaling_relations(observable="q_mmf3_mean"),"m_lens":sr.scaling_relations(observable="m_lens")}
scaling_relations["q_mmf3_mean"].initialise_scaling_relation()

cosmology = cosmo.cosmology_model()

catalogue_planck = cat.cluster_catalogue(catalogue_name="Planck_MMF3_cosmo")
